...
Route::post('wechat/wechatAppNotify','AlipayController@wechatAppNotify');
...
Route::get('home/getRecommend', 'HomeController@getRecommend');
...
Route::get('drivingSchool/getAdminEnrollRecord','DrivingSchoolController@getAdminEnrollRecord');
...
Route::post('education/enroll','EducationController@enroll');
...
Route::get('business/orderInfo/getOrderInfo','ShopAdmin\OrderInfoController@getOrderInfo');
...
Route::post('business/orderInfo/checkPickCode','ShopAdmin\OrderInfoController@checkPickCode');
...
Route::group(['middleware' => 'mbusiness'], function () {
