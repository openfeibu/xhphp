...
class OrderInfoRepository
{
	...
	public function create(array $order_info)
	{
        try {
			...
			$shop = Shop::where('shop_id',$order_info->shop_id)->first();
			if($shop->shop_type == 3)
			{
