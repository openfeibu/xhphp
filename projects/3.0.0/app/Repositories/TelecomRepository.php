...
class TelecomRepository
{
	...
	{
		return TelecomEnrollment::select(DB::raw('telecom_enrollment.name as "姓名",user.mobile_no as "手机号码",telecom_enrollment.created_at as "日期",school_campus.campus_name as "校区",school_building.building_no as "栋",telecom_enrollment.dormitory_number as "宿舍号"'))
