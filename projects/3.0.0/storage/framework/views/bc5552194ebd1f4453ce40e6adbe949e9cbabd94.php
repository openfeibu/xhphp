...
<body >
      ...
      <div class="fb-home-power">
        ...
        <ul>
          <li  class="power03 web-active">
           <a  onclick="winGo('<?php echo e(url('/mbusiness/order')); ?>#/wfh')">未发货</a>
          </li>
          <li class="power04 web-active">
            <a  onclick="winGo('<?php echo e(url('/mbusiness/order')); ?>#/yfh')">已发货</a>
          </li>
          <li class="power05 web-active">
            <a  onclick="winGo('<?php echo e(url('/mbusiness/order')); ?>#/ywc')">已完成</a>
          </li>
          <li class="power06 web-active">
            <a  onclick="winGo('<?php echo e(url('/mbusiness/order')); ?>#/thsh')">退货与售后</a>
          </li>
        </ul>
         <div class="power-title">商品管理</div>
        <ul>
          <li class="power01 web-active">
            <a onclick="winGo('<?php echo e(url('/mbusiness/product')); ?>#/product')">我的宝贝</a>
          </li>
          <li class="power01 web-active">
            <a onclick="winGo('<?php echo e(url('/mbusiness/product')); ?>#/classify')">分类管理</a>
          </li>
          <li class="power01 web-active">
  ...
  <template id="center">
    <div class="main pd bgf5 boxSizing" style=" min-height:100%;">
        ...
        <mt-button style="margin-top:0.5rem" size="large" type="danger" onclick="window.location.href='<?php echo e(url('mbusiness/logout')); ?>'">注销</mt-button>
        <!-- 日期修改 -->
          <mt-datetime-picker
              ref="open"
              type="time"
