    ...
    <div>
      <section id="worder_de" class="pd">
          ...
          <div class="order_money clearfix">
                ...
                <p><label for="" class="fl">红包(元)：</label><span  class="fr">-￥0.00</span></p>
          </div>
          ...
          <div class="submitButton"><div class="delivery opa_active" style="width: 100%;" @click="delivery(nowwlist.order_id)">我要发货</div></div>
              <mt-popup
  ...
  <template id="corderDe">
    <div>
      <section id="worder_de" class="pd">
          ...
          <div class="checkMap" v-if="nowclist.task">
                  <div class="usermap">
                    <div class="li_header">
