...
class Constants {
	...
	{
		if (!self::$packageName or !self::$secret) {
			self::$packageName = config('xiaomi.package');
			self::$secret = config('xiaomi.secret');
		}
	}

	public static function setPackage($package){
		self::$packageName = $package ?: config('xiaomi.package');
	}

	public static function setSecret($secret){
		self::$secret = $secret ?: config('xiaomi.secret');
	}
